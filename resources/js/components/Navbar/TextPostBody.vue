    ...
    <div id="ModalBody">
        <form @submit.prevent="submit" action="">
            ...
            <textarea v-model="form.description" rows="22"
                class="my-5 mx-28 h-full w-5/6 text-white border border-blue-900 bg-gray-900/25 resize-none outline outline-none rounded-sm p-2"
                placeholder="Add Text ..." />
            <hr class="border border-blue-900" />

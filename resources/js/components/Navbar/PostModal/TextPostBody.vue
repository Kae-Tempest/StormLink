                ...
                <div class="flex flex-col text-2xl my-[25.5px] mx-3">
                    <label class="2xl:py-5">
                        <input name="PostSize" type="radio" value="small" v-model="form.size"
                            class="p-2 mr-3.5 ml-1.5 appearance-none rounded-[5px] h-2 w-2 outline outline-3 outline-secondary outline-offset-4 checked:inline-block checked:bg-secoutline-secondary" />Small
                    </label>
                    <label class="py-5">
                        <input name="PostSize" type="radio" value="large" v-model="form.size"
                            class="p-2 mr-3.5 ml-1.5 appearance-none rounded-[5px] h-2 w-2 outline outline-3 outline-secondary outline-offset-4 checked:inline-block checked:bg-secoutline-secondary" />Large
                    </label>
                </div>
